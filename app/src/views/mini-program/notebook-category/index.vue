    ...
    <el-card shadow="never" class="develop-shell admin-workspace-shell">
      ...
      <div class="develop-hero">
        <div class="develop-hero__copy">
          <div class="develop-hero__eyebrow">NOTEBOOK CATEGORY</div>
          <h1 class="develop-hero__title">笔记分类</h1>
          <p class="develop-hero__desc">管理笔记文章的分类目录</p>
        </div>
      </div>
      ...
      <div class="develop-table-shell">
        <div class="develop-table-shell__header">
          <div>
            <div class="develop-table-shell__title">笔记分类列表</div>
            <div class="develop-table-shell__desc">定义笔记文章的层级结构与排序。</div>
          </div>
